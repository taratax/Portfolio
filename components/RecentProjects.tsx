        ...
        <div id='projects' className="py-20">
            ...
            >
                {projects.map(({ id, title, des, img, iconLists, link }) => {
                    return (
                        <div key={id}
                            className="sm:h-[41rem] h-[32rem] lg:min-h-[48.5rem] flex items-center justify-center sm:w-[570px] w-[40vw]" suppressHydrationWarning={true}
                        ...
                        >
                            ...
                            <PinContainer title={link} href={link} >
                                ...
                                >
                                    ...
                                    <img src={img} alt={title} className="z-10 absolute top-16" />
                                </div>
                                <h1 className="font-bold lg:text-2xl md:text-xl text-base line-clamp-1  mt-2 mb-5">
                                    {title}
                                </h1>
                                <p className="lg:text-xl lg:font-normal font-light text-sm line-clamp-4 ">
                                    {language === "pl" ? des[1] : des[0]}
                                </p>
                                {/* "flex items-center justify-between mt-7 mb-3 bg-white-100" */}
